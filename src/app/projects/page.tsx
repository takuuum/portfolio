        ...
        <div className='flex-1'>
          ...
          <div className='space-y-3'>
            <div className='flex items-start gap-2'>
              ...
              <div>
                <span className='text-xs font-medium text-gray-600 dark:text-gray-400 uppercase tracking-wide'>Role</span>
            ...
            <div className='flex items-start gap-2'>
              ...
              <div className='flex-1'>
                <span className='text-xs font-medium text-gray-600 dark:text-gray-400 uppercase tracking-wide'>Tech Stack</span>
        ...
        <div className='max-w-4xl mx-auto space-y-8'>
          ...
          <section className='text-center space-y-4'>
            ...
            <div>
              ...
              <p className='text-lg text-gray-600 dark:text-gray-300 mt-2'>
                A collection of projects and products I've worked on
              </p>
            </div>
          </section>
          ...
          <section className='bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border'>
            ...
            <div className='mt-6 space-y-4'>
              <h4 className='font-semibold text-gray-900 dark:text-gray-100'>Technology Categories</h4>
