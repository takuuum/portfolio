      ...
      <div className='flex items-start gap-4'>
        ...
        <div className='flex-1'>
          <div className='flex items-start justify-between mb-3 gap-4'>
            ...
            >
              <span className='hidden md:inline'>{t('readArticle')}</span>
  ...
  const technicalArticles = [
    {
      ...
      description: "アプリケーションアーキテクチャの異なる層におけるDBトランザクション実装パターンの深掘り。サービス層、リポジトリ層、ユースケース層でのトランザクション実装のトレードオフを、実践的な例と複雑なアプリケーションでのデータ一貫性を維持するベストプラクティスを紹介。"
    },
    {
      title: "OpenTelemetry+Go 計装サンプル大全 with Cloud Trace ~意外なつまづきポイントを添えて~",
      platform: "Zenn",
      url: "https://zenn.dev/cloud_ace/articles/opentelemetry-go",
      description: "Google Cloud Traceを使ったGoアプリケーションにおけるOpenTelemetry計装の包括的なガイド。よくある落とし穴、ベストプラクティス、実践的な実装パターンを紹介。",
    ...
    },
    {
      ...
      description: "継続的な運用コストをゼロにしたWebアプリケーションの構築とデプロイのための詳細な技術アーキテクチャ。クラウドサービスの無料枠、サーバーレスアーキテクチャ、静的サイト生成を活用して、パフォーマンスとスケーラビリティを維持しながらインフラ費用を最小化する方法を紹介。"
    },
    {
  ...
  const personalArticles = [
    {
      ...
      description: "3つの受賞や10回の登壇などを含む2024年の活動を振り返る。テックリード・アーキテクトとしての役割、SRE分野への初挑戦、アメリカでのGoogleイベント参加など、激動の1年間の成長記録。"
    },
    {
      title: "ジャッジしない、カテゴライズしない",
      platform: "note",
      url: "https://note.com/mizutaku0705/n/ne9663e965121",
      description: "性別、ジェンダー、情報のカテゴライズについての深い思索。シンプル化された情報やカテゴライズによって削ぎ落とされるもの、無かったことにされるマイノリティの存在について考察。多角的な情報収集と判断の重要性を紹介。"
    },
    {
